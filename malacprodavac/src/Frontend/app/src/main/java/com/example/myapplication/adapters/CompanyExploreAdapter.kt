...
import com.example.myapplication.ui.ExploreActivity
import com.example.myapplication.ui.HomeActivity
import com.example.myapplication.ui.UserProfileActivity
import com.example.myapplication.utils.StaticAddress
import java.util.HashMap

class CompanyExploreAdapter(private val context: Context, private val companies: List<CompanyCard>, private val activity: ExploreActivity) :
    RecyclerView.Adapter<CompanyExploreAdapter.CompanyViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CompanyViewHolder {
        val itemView = LayoutInflater.from(context).inflate(R.layout.grid_one_company, parent, false)
